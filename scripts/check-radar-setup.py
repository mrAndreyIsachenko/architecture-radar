...
REQUIRED_FILES = [
    ...
    "docs/family-playbooks/privacy-networking-vpn.md",
    "docs/family-playbooks/drones-robotics-autonomy.md",
    "docs/family-playbooks/satellites-space-systems.md",
    ...
    "scripts/check-opportunity-radar-cadence.sh",
    ...
    "scripts/test-agent-governance-negative.py",
    ...
    "tests/fixtures/agent-governance/negative_cases.json",
...
OPPORTUNITY_WORKFLOW_NEEDLES = [
    ...
    "30 8 * * *",
    "30 11 * * *",
    "OPPORTUNITY_RADAR_CATCHUP_DAYS",
    "scripts/check-opportunity-radar-cadence.sh",
    "contents: write",
    "pull-requests: write",
    "OPENAI_API_KEY",
