...

{
  ...
  printf -- '- Do not mark an opportunity `selected-for-build` unless spend_score >= 3, reachability_score >= 3, timing_score >= 2, buildability_score >= 3, paid_experiment is concrete, and at least three source classes support it.\n'
